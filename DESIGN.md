...
- **Один акцент** — приглушённый фиолетовый highlight. Других цветов нет
  (ссылки в тёмной теме — мятные, это единственное исключение, осознанное).
...
| `--color-link` | `#000` | `#A8D8B9` | Ссылки |
| `--color-link-hover` | `#666` | `#83AD94` | Ссылки при наведении |
...
| `--highlight-color` | `rgba(167,139,250,.2)` | `rgba(167,139,250,.4)` | Маркер `.highlight` |
...
**Не делай:**
- не вводи новые цвета (палитра — две темы + один highlight);
